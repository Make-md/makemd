...
const filterForAny = (props: {[key: string]: any}, filters: SpaceDefFilter[]) : boolean => {
  ...
  const filterForProps = (props: {[key: string]: any}, def: SpaceDefFilter) : boolean => {
  ...
  const filterPathsForAll = ( props: {[key: string]: any}, filters: SpaceDefFilter[]) : boolean => {
    return filters.reduce((p, c) => {
...
export const resultForFilters = ( filters: SpaceDefGroup[], props: {[key: string] : any}) => {
