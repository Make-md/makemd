...
export const NewNotes = (props: NewNotesComponentProps) => {
    ...
    return <div className='mk-flow-bar'>
        <button aria-label={t.buttons.newNote} className='mk-new-note' onClick={() => newFile()}>
            <div dangerouslySetInnerHTML={{__html: uiIconSet['mk-ui-new-note']}}></div>
