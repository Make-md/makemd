...
export const MainMenu = (props: MainMenuComponentProps) => {
    ...
    return <div className='mk-main-menu-container'>
    <div className='mk-main-menu-button' ref={ref} onClick={(e) => showMenu(e)}>
        {plugin.app.vault.getName()}
        <div dangerouslySetInnerHTML={{__html: uiIconSet['mk-ui-expand']}}></div>
